...
export const PlotlyTimeSeriesChart = React.memo(function PlotlyTimeSeriesChart({
  ...
  const { plotData, plotLayout } = useMemo(() => {
    ...
    const layout: any = {
      title: {
        text: title,
        font: { size: 20, family: "Inter, sans-serif", color: "#111827" },
        x: 0.02,
        xanchor: "left",
      },
      xaxis: {
        title: { text: "Time", font: { size: 15, color: "#374151", weight: "bold" } },
      ...
      yaxis: {
        title: { text: yAxisLabel, font: { size: 15, color: "#374151", weight: "bold" } },
        tickfont: { size: 13, color: "#4B5563" },
        showgrid: true,
        gridcolor: "#f1f5f9",
        tickformat: ".2f",
